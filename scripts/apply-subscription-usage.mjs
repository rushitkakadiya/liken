...
if (!password) {
  console.error(
    "Missing SUPABASE_DB_PASSWORD in .env\n" +
      ...
      "Or run supabase/migrations/005_subscription_usage.sql in the SQL Editor.",
  );
  process.exit(1);
}

const sql = fs.readFileSync(
  path.join(__dirname, "../supabase/migrations/005_subscription_usage.sql"),
  "utf8",
);
...
try {
  ...
  console.log("Applying 005_subscription_usage.sql...");
  await client.query(sql);
  console.log("Subscription/usage migration applied successfully.");
} catch (err) {
